...
public class Media extends Scuola {
    ...
    public String toString() {
        return super.toString() + String.format("Contributo per gli studenti: %d Contributo per i laboratori: %d Contributo per le sedi: %d", getContributoStudenti(),getContributoLaboratori(),getContributoSedi());
    }
}